...
class RequestHandlerClient
{
    ...
    public function run()
    {
        ...
        $headers['auth']['clientId'] = 5314;
        $headers['auth']['clientCompany'] = "enE6JGLGRYNI5xExz6YH";
        $headers['auth']['clientSecret'] = "NTMxNGVuRTZKR0xHUllOSTV4RXh6NllIY2U2NmY2ZTZmOWRlZjUxMGFjNDBiYTJlNjVjMmFjZGEwMTQyZmZhZQ==";
